...
const citiesInMorocco = [
  ...
  "Safi", "Mohammédia", "El Jadida", "Béni Mellal", "Nador", "Taza",
  "Khouribga"
];
              ...
              <>
                ...
                <motion.div variants={itemVariants} className="mt-4">
                  <Label className="flex items-center gap-2">
                      <Checkbox
                      id="scholarship.isRecipient"
                      checked={isChecked}
                      onChange={(value) => {
                        const syntheticEvent = {
                          target: {
                            name: "scholarship.isRecipient",
                            value: value
                          }
                  ...
                  {profile.personalInfo.scholarship?.isRecipient && (
                    <div className="mt-2 space-y-2 pl-6">
                      <div>
                        ...
                        <Input
                          type="text"
                          name="scholarship.decisionNumber"
